        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              <div className="text-2xl font-bold text-cyan-600">{reportData.weekly.pickups}</div>
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-cyan-600">{reportData.weekly.leads}</div>
