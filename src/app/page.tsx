      ...
      <div className="flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-16 relative overflow-hidden min-h-[40vh] lg:min-h-screen">
        ...
        <div className="relative z-10 max-w-lg text-center text-white lg:text-left">
          <h1 className="mb-4 text-3xl font-bold leading-tight sm:text-4xl lg:text-5xl xl:text-6xl lg:mb-6">
            Welcome to Scrap Collection Service System
          </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
            ...
            <div className="flex justify-between items-center text-xs sm:text-sm">
              <label className="flex items-center text-gray-600">
                <input
                  ...
                  className="mr-2 w-3 h-3 text-purple-600 rounded border-gray-300 focus:ring-purple-500 sm:w-4 sm:h-4"
                />
                <span className="text-xs sm:text-sm">Remember</span>
              </label>
              <Link href="/auth/forgot-password" className="text-xs text-gray-500 transition-colors hover:text-purple-600 sm:text-sm">
                Forgot password?
              </Link>
            </div>
            ...
            <div className="text-center">
              <span className="text-xs text-gray-600 sm:text-sm">
                ...
                <Link href="/auth/signup" className="font-medium text-purple-600 transition-colors hover:text-purple-700">
                  Sign up
                </Link>
              </span>
            </div>
