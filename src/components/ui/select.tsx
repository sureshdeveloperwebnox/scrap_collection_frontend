...
>(({ className, children, ...props }, ref) => {
  // Check if this is a custom trigger (no default icon needed)
  const hasCustomIcon = className?.includes('bg-transparent') || className?.includes('p-0');
  ...
  <SelectPrimitive.Trigger
    ...
    className={cn(
        ...
        !hasCustomIcon && "[&>span]:line-clamp-1",
      className
    )}
    {...props}
  >
