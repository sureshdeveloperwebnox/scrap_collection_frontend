...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn(
      "bg-gradient-to-r from-gray-50 to-gray-100/50 border-b-2 border-gray-200",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "border-t-2 border-gray-200 bg-gray-50 font-medium",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tr
    ...
    className={cn(
      ...
      "data-[state=selected]:bg-cyan-50/50",
      className
    )}
    {...props}
  />
